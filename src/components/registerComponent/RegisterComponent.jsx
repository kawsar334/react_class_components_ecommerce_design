        ...
        return(
            <div className="login w-[90%] h-[100vh] flex justify-center items-center flex-col gap-4 m-auto capitalize ">
                <form action="" className="loginform w-[60%] m-auto  p-[20px] flex flex-col gap-[20px] shadow ">
                    <h1 className='text-2xl'><span className='text-[teal] font-semibold'>Register</span></h1>
                    <input type="text" name="" id="" placeholder='username' required className='w-[70%] h-[40px] border p-[20px] rounded outline-none' />
                    ...
                    <div className='flex justify-start gap-2'>
                        ...
                        <a className='text-[blue] cursor-pointer' onClick={this.props.toggleForm}>Login</a>
                    </div>
                </form>
            </div>
        )
